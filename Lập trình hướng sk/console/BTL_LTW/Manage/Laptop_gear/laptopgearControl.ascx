<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="laptopgearControl.ascx.cs" Inherits="BTL_LTW.Manage.Laptop_gear.laptopgearControl" %>
<style>
    .logoBrand{
        margin-top:50px;
        margin-left:100px;
...
<div id="bannerVP">
    <img src="../../img/banner_gg.png" alt="" />
</div>
<div class="logoBrand">
    <ul>
        <li><img src="../../img/brandAcer.jpg" alt="" /></li>
        <li><img src="../../img/brandAsus.jpg" alt="" /></li>
        <li><img src="../../img/brandDell.jpg" alt="" /></li>
        <li><img src="../../img/brandHp.jpg" alt="" /></li>
        <li><img src="../../img/brandLenovo.jpg" alt="" /></li>
        <li><img src="../../img/brandLG.jpg" alt="" /></li>
        <li><img src="../../img/brandMacbook.jpg" alt="" /></li>
        <li><img src="../../img/brandMsi.jpg" alt="" /></li>
    </ul>
</div>

<div id="sanPham">
        <div class="items">
        <div data-product-id="pg1" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg2" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg3" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg4" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg5" class="slider_product_one_content_item">
    ...
    <div class="items">
        <div data-product-id="pg6" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg7" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg8" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg9" class="slider_product_one_content_item">
        ...
        <div data-product-id="pg10" class="slider_product_one_content_item">
...
<div id="containerMoTa">
    <img src="../../img/imgBannerGG.png" alt="" />
     <p style="margin:16px"> Bạn là một người chơi game nghiệp dư, chuyên nghiệp hay đang muốn luyện tập để trở nên giỏi hơn? 
         Điều bạn cần nhất lúc này là một bộ gear có thể giúp bạn có được những trải nghiệm tốt nhất trong quá trình chơi game.
        LongVuong cam kết hàng chính hãng 100%, chính sách thanh toán linh hoạt luôn đi cùng các chính
        sách ưu đãi hấp dẫn. Cập nhật ngay những mẫu <b>Gaming Gear</b> hot nhất hiện đang có mặt tại LongVuong ngay sau đây nhé!</p>
</div>
