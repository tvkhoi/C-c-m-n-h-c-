...
namespace BTL_LTW.Manage.Laptop_vanphong
{
    public partial class laptopvanphongControl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filePath = @"D:\Lập trình hướng sk\console\BTL_LTW\dat_VanPhong.json";
