<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="laptopvanphongControl.ascx.cs" Inherits="BTL_LTW.Manage.Laptop_vanphong.laptopvanphongControl" %>
...
<div id="sanPham">
        <div class="items">
        <div data-product-id="vp1" class="slider_product_one_content_item">
        ...
        <div data-product-id="vp2" class="slider_product_one_content_item">
        ...
        <div data-product-id="vp3" class="slider_product_one_content_item">
        ...
        <div data-product-id="vp4" class="slider_product_one_content_item">
        ...
        <div data-product-id="vp5" class="slider_product_one_content_item">
    ...
    <div class="items">
        ...
        <div data-product-id="vp8" class="slider_product_one_content_item">
        ...
        <div data-product-id="vp9" class="slider_product_one_content_item">
        ...
        <div data-product-id="vp10" class="slider_product_one_content_item">
...
<div id="containerMoTa">
     <p style="margin:16px"> <b>Laptop văn phòng</b> là một trong những thương hiệu được ưa chuộng hiện nay vì chất lượng và giá thành phù hợp với đa dạng người dùng.
        LongVuong cam kết hàng chính hãng 100%, chính sách thanh toán linh hoạt luôn đi cùng các chính
        sách ưu đãi hấp dẫn. Cập nhật ngay những mẫu <b>Laptop văn phòng</b> hot nhất hiện đang có mặt tại LongVuong ngay sau đây nhé!</p>
    <img src="../../img/imgBannerVp.png" alt="" />
</div>
