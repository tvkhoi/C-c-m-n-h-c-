...
namespace BTL_LTW.Manage.Phanmem
{
    public partial class phanmemControl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filePath = @"D:\Lập trình hướng sk\console\BTL_LTW\dat_PhanMem.json";
