...
<div id="sanPham">
        <div class="items">
        <div data-product-id="pk1" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk2" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk3" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk4" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk5" class="slider_product_one_content_item">
    ...
    <div class="items">
        <div data-product-id="pk6" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk7" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk8" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk9" class="slider_product_one_content_item">
        ...
        <div data-product-id="pk10" class="slider_product_one_content_item">
