<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="laptopgamingControl.ascx.cs" Inherits="BTL_LTW.Manage.Laptop_gaming.laptopgaming" %>
<style>
    .logoBrand{
        margin-top:50px;
        margin-left:100px;
...
<div id="bannerVP">
    <img src="../../img/banner_gaming.png" alt="" />
</div>
<div class="logoBrand">
    <ul>
...
<div id="containerMoTa">
    <img src="../../img/imgBannerGM.png" alt="" />
     <p style="margin:16px"> <b>Laptop Gaming</b> là một trong những thương hiệu được ưa chuộng hiện nay với cấu hình, chất lượng và giá thành phù hợp với đa dạng người dùng.
        LongVuong cam kết hàng chính hãng 100%, chính sách thanh toán linh hoạt luôn đi cùng các chính
        sách ưu đãi hấp dẫn. Cập nhật ngay những mẫu <b>Laptop Gaming</b> hot nhất hiện đang có mặt tại LongVuong ngay sau đây nhé!</p>
</div>
