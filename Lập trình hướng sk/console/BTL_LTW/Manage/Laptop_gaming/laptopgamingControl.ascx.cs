...
namespace BTL_LTW.Manage.Laptop_gaming
{
    public partial class laptopgaming : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filePath = @"D:\Lập trình hướng sk\console\BTL_LTW\dat_Gaming.json";
