...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var themvaogiohang = document.getElementById("themvaogiohang");
    ...
    <div class="detail_content">
        ...
        <div class="box_main">
            ...
            <div class="box_main_right">
                ...
                <div class="muahang">
                    <button runat="server" id="themvaogiohang" style="width: 60%; border-color: #fb6e2e;color: white; background-color: #fb6e2e;height: 50px;text-align: center;border-radius: 3px;font-size: 20px;">MUA NGAY</button>
                </div>
            </div>
            </div>
