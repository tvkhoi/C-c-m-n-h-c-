...
public class FrameLayout_nhapthong_tin extends DialogFragment {
    ...
    private void Add_table_layout_thong_tin(View view) {
        ...
        if(MainActivity.chuoi_tien.isEmpty()!=true&&MainActivity.chi_tiet_tien.isEmpty()!=true) {
            float a = Float.valueOf(MainActivity.chuoi_tien);
                                    ...
                                    if (chuoi != "") {
                                       ...
                                       int tab_layout = activity_add.tabLayout.getSelectedTabPosition();
                                        ...
                                        if (MainActivity.chuoi_tien.isEmpty() != true && MainActivity.chi_tiet_tien.isEmpty() != true) {
                                                ...
                                                chitiet_chiphi_thu_nhap chitiet_chiphi_thu_nhap = list1.get(Adapter_chiphi_thunhap.vitri_cuaphantu_cansua);
                                                if (MainActivity.tinhieu_sua == 1) {
                                                    if(chuoi!="") {
                                                        MainActivity.database.QueryData("UPDATE Chitiet_chiphi_thunhap  SET ten = '" + editText.getText().toString().trim() + "', so_tien = '" + chuoi + "', icon = '" + vitri_icon + "' , tablayout = '" + tab_layout + "' WHERE vitrigroup = '" + Adapter_chiphi_thunhap.group_sua + "' AND ten = '" + chitiet_chiphi_thu_nhap.getTen() + "' AND so_tien = '" + chitiet_chiphi_thu_nhap.getSo_tien() + "' AND icon = '" + chitiet_chiphi_thu_nhap.getIcon() + "' AND tablayout = '" + chitiet_chiphi_thu_nhap.getTablayout() + "'  ");
                                                         Toast.makeText(activity_add, "Sửa thành công", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                                ...
                                                list1.set(Adapter_chiphi_thunhap.vitri_cuaphantu_cansua, chitiet_chiphi_thu_nhap);
                                                float tong_thu = 0;
                                                float tong_chi = 0;
...
//                                            if(chuoi=="") {
//                                                Toast.makeText(activity_add, "Vui lòng nhập số tiền", Toast.LENGTH_SHORT).show();
//                                            }
                                            float tong_chiphi = 0;
                                    ...
                                    if (chuoi.isEmpty() == true) {
                                        Toast.makeText(activity_add1, "Vui lòng nhập số tiền", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            if (chuoi.isEmpty() != true) {
                                so = Double.parseDouble(chuoi);
                            }
                            if (chuoi.equals("")) {
                                so = Double.parseDouble("0");
                            }
