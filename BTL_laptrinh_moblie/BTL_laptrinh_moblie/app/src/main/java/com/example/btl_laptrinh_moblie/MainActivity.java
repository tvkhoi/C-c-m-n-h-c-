...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      // int icon, int vitri_group, String ten, String so_tien, int tablayout
...
//        for (int i = 0;i<arrayList1.size();i++) {
//            database.QueryData("INSERT INTO Group1 VALUES ('"+ arrayList1.get(i).getVitri_group()+"','" +arrayList1.get(i).getNgay()+"','"+arrayList1.get(i).getThang()+"','" +arrayList1.get(i).getThu()+"','"+arrayList1.get(i).getChiphi().toString()+ "','" + arrayList1.get(i).getThu_nhap() + "','" + arrayList1.get(i).getNam() + "')");
//            Cursor dataGroup = database.GetData("SELECT * FROM Group1");
//                int vitri_group = dataGroup.getInt(0);
//                String ngayf = dataGroup.getString(1);
//                String thang = dataGroup.getString(2);
//                String thu = dataGroup.getString(3);
//                String chiphi = dataGroup.getString(4);
//                String thu_nhap = dataGroup.getString(5);
//                int namf = dataGroup.getInt(6);
//                Toast.makeText(this, "" + ngayf + thang + thu + chiphi + thu_nhap + namf, Toast.LENGTH_SHORT).show();
//         //   Toast.makeText(this, ""+arrayList1.get(i).getVitri_group(), Toast.LENGTH_SHORT).show();
//        }
//        database.QueryData("DELETE Chitiet_chiphi_thunhap");
//        for (int i = 0;i<arrayList1.size();i++) {
//            int soluong = arrayList1.get(i).getMembers().size();
//            for(int k = 0;k<soluong;k++) {
//                List<chitiet_chiphi_thu_nhap> list = arrayList1.get(i).getMembers();
//                database.QueryData("INSERT INTO Chitiet_chiphi_thunhap('"+list.get(k).icon+"','"+list.get(k).getVitri_group()+"','"+list.get(k).getSo_tien()+"','"+list.get(k).getTablayout()+"')");
//            }
//        }
        arrayList_group_trunggian.clear();
        arrayList1.clear();
